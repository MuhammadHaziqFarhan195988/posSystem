...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h4 class="mb-0">
                Edit Admin
                <a href="admins.php" class="btn btn-danger float-end">Back to the Admin Page</a>
            </h4>
        </div>
        <div class="card-body">
            <?php alertDialog() ?>
                        ...
                        <input type="hidden" name="adminId" value="<?= $adminData['data']['id']; ?>">
                         <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="phonenumber" value="<?= $adminData['data']['phonenumber']; ?>" class="form-control" />
                                </div>
                                ...
                                <div class="col-md-3 mb-3 text-end">
                                    <button type="submit" name="updateAdmin" class= "btn btn-primary"> Update info </button>
